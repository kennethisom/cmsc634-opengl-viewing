...
// area between three, area(v1, v2, v3), for Vec<2> only
template <typename T>
inline T area(const Vec<T,2> &v1, const Vec<T,2> &v2, const Vec<T,2> &v3) {
    T area = abs((v1[0] * (v2[1] - v3[1]) + v2[0] * (v3[1] - v1[1]) + v3[0] * (v1[1] - v2[1])) / 2);
    return area;
}
